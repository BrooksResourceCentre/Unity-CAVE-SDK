# Configuration
The CAVE dimesions this prefab where built off are three 1920x1080 displays for the walls (5760x1080) and one the floor is one 1080x1080 display, if your CAVE setup is the same, dragging in the "CAVE_Core" prefab will work out of the box. Note: you will still need to ensure the project settings below are set correctly.
